...
app.post('/insertRaid', (request, response) => {
    ...
    request.body.drops.forEach(drop => {
        ...
        UpdateLootSheetSQL += `update lootsheet set aquired = 'true' where item_id=${drop.item_id} and \"charUID\"= (select \"charUID\" from characters where \"charName\"='${drop.char_name}');`
